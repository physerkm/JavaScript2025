...
3. After the image has loaded, pause execution for 5 seconds using the wait function we created earlier;
4. After the 5 seconds have passed, hide the current image (set display to 'none'), and load a second image
...
5. After the second image has loaded, pause execution for 5 seconds again;
6. After the 5 seconds have passed, hide the current image.
